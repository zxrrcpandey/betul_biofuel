...
function _do_refresh_matrix(page) {
	...
	frappe.call({
		method: "trustbit_ethanol.ts_gate_entry.ts_budget.get_budget_dashboard",
		...
		callback(r) {
			...
			if (view_mode === "Summary") {
				...
				html += '<div style="color: #6b7280; padding: 15px; text-align: center;">Detailed account-wise view coming soon. Use the TS Budget Dashboard report for account-level breakdown.</div>';
			}

...
function _pd_do_refresh(page) {
	...
	frappe.call({
		method: "trustbit_ethanol.bbf_gate_entry.bbf_dashboard_procurement.get_procurement_dashboard",
...
function _pd_kpi_cards(s, cycle) {
	const cards = [
		...
		{ label: "Pending Approval", value: s.pending_count, color: "#f59e0b", bg: "#fffbeb",
		  click: "List/Purchase Order/bbf_approval_status=%5B%22like%22%2C%22Pending%25%22%5D" },
		{ label: "Rejected", value: s.rejected_count, color: "#ef4444", bg: "#fef2f2",
		  click: "List/Purchase Order/bbf_approval_status=Rejected" },
